  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      if (!formData.category) {
        toast.error(
          "Debes seleccionar una categoría para postular a la beca"
        );
        return;
      }
      ...
      if (
        ...
        toast.error(
          "Para categoría Junior la edad debe estar entre 12 y 15 años"
        );
        return;
      }
      ...
      if (
        ...
        toast.error(
          "Para categoría Senior la edad debe estar entre 16 y 18 años"
        );
        return;
      }
    }
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-xs text-gray-500 mt-2 font-lato">
                El valor de inscripción dependerá de la actividad
                seleccionada.
              </p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200">
            <p className="text-xs font-lato text-gray-600 mb-6">
              Al enviar este formulario, aceptas que tus datos serán
              utilizados para procesar tu inscripción. Nos
              contactaremos contigo con los detalles de pago.
            </p>
